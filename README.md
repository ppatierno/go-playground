...
Another important environment variable is `GOPATH="/home/<user>/go"` (if `go` folder doesn't exist you have to create it or choose a different one). This is the path where source codes of your applications live and where Go searches for custom packages (not the system ones).
